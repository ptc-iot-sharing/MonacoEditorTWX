...
TW.jqPlugins.twCodeEditor.prototype.showCodeProperly = function () {
    ...
    require(["vs/editor/editor.main"], function () {
        ...
        editorSettings.model = monaco.editor.createModel(codeValue, mode,
            new monaco.Uri("thingworxTypescript" + serviceModel.model.entityType + serviceModel.model.id + serviceName));
                ...
                TW.IDE.showModalDialog({
                    ...
                    show: function (popover) {
                        ...
                        editorSettings.value =
                            JSON.stringify(Utilities.flatten(TW.monacoEditor.defaultEditorSettings), null, "\t");
