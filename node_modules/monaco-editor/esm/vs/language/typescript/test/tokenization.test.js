...
suite('tokenization', function () {
    function executeTokenizationTests(tests) {
        var tokenizationSupport = createTokenizationSupport(Language.EcmaScript5);
        for (var i = 0, len = tests.length; i < len; i++) {
            assert.ok(true, 'TEST #' + i);
            executeTokenizationTest(tokenizationSupport, tests[i]);
        }
    }
    function executeTokenizationTest(tokenizationSupport, tests) {
